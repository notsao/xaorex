...
function Card({ icon, title, description, author, url}) {
  return (
    <div className="flex flex-col items-center bg-white p-7 rounded-[31px] shadow-md w-1/4 h-[700px]justify-around">
      ...
      <p className=" text-black mx-[5px] text-left">{description}</p>
      <a href={url} className="text-white bg-black px-5 py-2 rounded mt-5 hover:bg-gray-800 hover:cursor-pointer">Read More</a>
